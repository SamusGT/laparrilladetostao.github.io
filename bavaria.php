...
<head>
    <meta charset="UTF-8">
    <title>Productos Bavaria</title>
    <link rel="stylesheet" href="diseño_bavaria.css">
</head>
<body>
    <h1>Productos Bavaria</h1>
    ...
    <div class="centrado">
        <a href="crear_producto_bavaria.html"><button class="btn-verde">Añadir producto</button></a>
    </div>
        ...
        <?php if ($resultado->num_rows > 0): ?>
            <?php while ($fila = $resultado->fetch_assoc()): ?>
                <div class="producto">
                    ...
                    <form action="añadir_cantidad_bavaria.php" method="POST">
                    ...
                    <form action="eliminar_producto_bavaria.php" method="POST">
                        <input type="hidden" name="id" value="<?php echo $fila['id']; ?>">
