...
<head>
    ...
    <link rel="stylesheet" href="diseño_postobon.css">
</head>
<body>
    <h1>Productos Postobón</h1>
    ...
    <div class="centrado">
        <a href="crear_producto_postobon.html"><button class="btn-verde">Añadir producto</button></a>
    </div>
        ...
        <?php if ($resultado->num_rows > 0): ?>
            <?php while ($fila = $resultado->fetch_assoc()): ?>
                <div class="producto">
                    ...
                    <form action="añadir_cantidad_postobon.php" method="POST">
                    ...
                    <form action="eliminar_producto_postobon.php" method="POST">
                        <input type="hidden" name="id" value="<?php echo $fila['id']; ?>">
