...
<head>
    <meta charset="UTF-8">
    <title>Productos de Otras Carnes</title>
    <link rel="stylesheet" href="diseño_postobon.css"> <!-- mismo CSS -->
</head>
<body>
    <h1>Productos de Otras Carnes</h1>
    ...
    <div class="centrado">
        <a href="crear_producto_otras_carnes.html"><button class="btn-verde">Añadir producto</button></a>
    </div>
        ...
        <?php if ($resultado->num_rows > 0): ?>
            <?php while ($fila = $resultado->fetch_assoc()): ?>
                <div class="producto">
                    ...
                    <form action="añadir_cantidad_otras_carnes.php" method="POST">
                    ...
                    <form action="eliminar_producto_otras_carnes.php" method="POST">
                        <input type="hidden" name="id" value="<?php echo $fila['id']; ?>">
