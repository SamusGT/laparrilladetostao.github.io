...
<body>
    ...
    <div class="centrado">
        <a href="crear_producto_res.html"><button class="btn-verde">Añadir producto</button></a>
    </div>
        ...
        <?php if ($resultado->num_rows > 0): ?>
            <?php while ($fila = $resultado->fetch_assoc()): ?>
                <div class="producto">
                    ...
                    <form action="añadir_cantidad_res.php" method="POST">
                    ...
                    <form action="eliminar_producto_res.php" method="POST">
                        <input type="hidden" name="id" value="<?php echo $fila['id']; ?>">
