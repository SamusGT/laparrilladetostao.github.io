...
<head>
    <meta charset="UTF-8">
    <title>Productos Postobón</title>
    <link rel="stylesheet" href="diseño_coca_cola.css">
</head>
<body>
    <h1>Productos Coca-Cola</h1>
    ...
    <div class="centrado">
        <a href="crear_producto_coca_cola.html"><button class="btn-verde">Añadir producto</button></a>
    </div>
        ...
        <?php if ($resultado->num_rows > 0): ?>
            <?php while ($fila = $resultado->fetch_assoc()): ?>
                <div class="producto">
                    ...
                    <p>Vence: <?php echo $fila['vencimiento']; ?></p>
                    <img src="<?php echo $fila['imagen']; ?>" alt="Imagen" class="producto-imagen">

                    <form action="añadir_cantidad_coca_cola.php" method="POST">
                    ...
                    <form action="eliminar_producto_coca_cola.php" method="POST">
                        <input type="hidden" name="id" value="<?php echo $fila['id']; ?>">
